...
class WeeklyReports extends Model
{
    ...
    public function toDateForm1(){
        $fieldsToSum =  [
            'manufactured', 'A', 'B', 'C', 'C1', 'D', 'DX', 'DE', 'DR', 'total_issuance', 'prev_manufactured', 'prev_A', 'prev_B', 'prev_C', 'prev_C1', 'prev_D', 'prev_DX', 'prev_DE', 'prev_DR', 'prev_total_issuance', 'tdc', 'gtcm', 'lkgtc_gross', 'lkgtc_net', 'ntcm', 'share_planter', 'share_miller', 'tds','egtcm', 'lkgtc_gross_syrup', 'prev_transfers_to_refinery', 'transfers_to_refinery', 'form1_prev_unquedanned',
        ];
...
//        dd($this->hasMany(RequestsForCancellation::class,'weekly_report_slug','slug')->where('action','=',null)->getBindings());
