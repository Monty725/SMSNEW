...
<h4 class="text-strong">B. Quedan Registry <button type="button" data-target="#add_form5a_issuances_modal" data-toggle="modal" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Add Quedan Registry</button></h4>
