                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <dl>
                                <dd>TOTAL:</dd>
                                <dt for="form3bTotalIssuance">0.0000</dt>
                            </dl>
                        </div>
                        ...
                        <div class="col-md-3">
                            <dl>
                                <dd>TOTAL Current:</dd>
                                <dt for="form3bTotalCurrentIssuance">0.0000</dt>
                            </dl>
                        </div>
                        ...
                        <div class="col-md-3">
                            <dl>
                                ...
                                <dt for="form3bTotalPrevIssuance">0.0000</dt>
                            </dl>
                        </div>
                        ...
                        <div class="col-md-3">
                            <button
                                    type="button"
                                    data-target="#add_form3b_issuances_modal"
                                    data-toggle="modal"
                                    class="btn btn-success btn-sm pull-right">
                                <i class="fa fa-plus"></i> Add Issuances
                            </button>
                        </div>
                    </div>
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <td id="totalMROQty" class="text-right">
                ...
                <div class="box-body" style="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <dl>
                                <dd>TOTAL:</dd>
                                <dt for="form3bTotalDelivery">0.0000</dt>
                            </dl>
                        </div>
                        ...
                        <div class="col-md-3">
                            <dl>
                                <dd>TOTAL Current:</dd>
                                <dt for="form3bTotalCurrentDelivery">0.0000</dt>
                            </dl>
                        </div>
                        ...
                        <div class="col-md-3">
                            <dl>
                                <dd>TOTAL Previous:</dd>
                                <dt for="form3bTotalPrevDelivery">0.0000</dt>
                            </dl>
                        </div>

                        <div class="col-md-3">
                            <button type="button"
                                    data-target="#add_form3b_deliveries_modal"
                                    data-toggle="modal"
                                    class="btn btn-success btn-sm pull-right">
                    ...
                    <table style="width: 100%;"
                        ...
                        <tr>
                            ...
                            <td id="totalQty" class="text-right">
                                <strong>0.0000</strong>
                            </td>
